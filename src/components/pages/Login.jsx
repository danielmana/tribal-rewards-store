...
var LoginPage = React.createClass({
          ...
          <div className="row">
            <div className="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
              ...
              <form role="form" onSubmit={this.handleLogin} className="ng-pristine ng-valid">
                ...
                <button type="submit" className="btn btn-gray btn-outline btn-lg btn-rounded">Login</button>
              </form>
            </div>
          </div>
        </div>
  ...
  handleLogin: function(e){
    ...
    e.preventDefault();
    this.props.history.pushState(null, '/main/overview');
