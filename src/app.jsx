  ...
  childRoutes: [
    {
      ...
      indexRoute: {component: require('./components/pages/main/Overview')},
      childRoutes: [
        require('./components/pages/main/Overview'),
        require('./components/pages/main/Reports'),
        require('./components/pages/main/Terms'),
        require('./components/pages/main/Privacy'),
        require('./components/pages/main/Contact')
      ]
    },
    {
      path: '/login',
